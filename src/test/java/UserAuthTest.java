...
public class UserAuthTest {
    ...
    public void testAuthUser(){
        ...
        assertTrue(responseGetAuth.jsonPath().getInt("user_id") > 0, "User id should be > 0");

        JsonPath responseChechAuth = RestAssured
                .given()
        ...
        int userIdOnCheck = responseChechAuth.getInt("user_id");
